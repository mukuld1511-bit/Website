    ...
    return (
      <div className="min-h-screen bg-[#050008] flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/login">
            <button className="px-6 py-3 rounded-xl bg-gradient-to-r from-pink-600 to-rose-600 text-white font-black hover:from-pink-500 hover:to-rose-500 transition">
              Sign In
            </button>
          </Link>
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <div className="mb-10">
            ...
            <h1 className="text-4xl md:text-6xl font-black tracking-tighter text-white leading-none mb-3">
              Post a <span className="text-pink-500">Request</span>
            </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="rounded-3xl border border-white/6 bg-white/[0.025] backdrop-blur-xl p-8">
              ...
              <div className="space-y-5">
                ...
                <div>
                  <label className="block text-xs font-black uppercase tracking-[0.2em] text-white/40 mb-2">Required Skills (Optional)</label>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button type="button" onClick={handleAddSkill}
                      className="px-5 py-3 rounded-xl bg-white/5 border border-white/10 text-white/60 font-black text-xs hover:bg-white/10 hover:text-white transition">
                      Add
                    </button>
                  </div>
                </div>
