...
export default function LearnerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] flex flex-col font-sans">      <div className="max-w-4xl mx-auto px-4 py-14 flex-grow w-full">
        <div className="mb-8">
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <Link href="/hire">
            <div className="bg-white border border-gray-200 rounded-2xl p-5 hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group">
              ...
              <p className="font-black text-white text-sm mb-1">Book a Mentor</p>
          ...
          <Link href="/learn">
            <div className="bg-white border border-gray-200 rounded-2xl p-5 hover:shadow-md hover:-translate-y-0.5 transition-all cursor-pointer group">
              ...
              <p className="font-black text-white text-sm mb-1">Browse Workshops</p>
          ...
          <div className="space-y-4">
            {loading ? (
              ...
              <div className="text-center py-16 bg-white rounded-2xl border border-gray-200">
                ...
                <p className="font-bold text-white mb-1">No sessions booked yet</p>
              ...
              <motion.div key={s.id} initial={{opacity:0,y:8}} animate={{opacity:1,y:0}}
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-black text-white text-sm">{s.mentorName}</p>
        ...
        {tab==="workshops" && (
          <div className="space-y-4">
            {workshops.length===0 ? (
              <div className="text-center py-16 bg-white rounded-2xl border border-gray-200">
                <p className="text-4xl mb-3">🎓</p>
                <p className="font-bold text-white mb-1">No workshops registered yet</p>
