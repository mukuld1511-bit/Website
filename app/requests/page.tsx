          ...
          <div className="grid md:grid-cols-2 gap-6 mb-16">
            {OPTIONS.map((opt, i) => (
              <motion.div key={i} initial={{ opacity:0, y:24 }} animate={{ opacity:1, y:0 }}
                ...
                <Link href={opt.href}>
                  <div className="group relative h-full rounded-3xl border border-white/6 bg-white/[0.025] backdrop-blur-xl overflow-hidden hover:border-white/14 transition duration-300 cursor-pointer p-8 flex flex-col min-h-[360px]">
                    ...
                    <div className="flex items-center gap-2 text-sm font-black group-hover:gap-3 transition-all duration-200 mt-auto"
