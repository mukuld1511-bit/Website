...
const EXPLORE_LINKS = [
  ...
  { label: "WebXR Experiences", href: "#", desc: "Immersive web demos", icon: "M15 12a3 3 0 11-6 0 3 3 0 016 0z" },
...
const LEARN_CONNECT_LINKS = [
  ...
  { label: "Community Forum", href: "#", desc: "Ask questions, share ideas", icon: "M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" },
  { label: "Live Workshops",  href: "#", desc: "Join upcoming online events", icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" }
];

const ACADEMY_LINKS = [
  { label: "Learning Paths",     href: "#",               desc: "Structured courses for 3D/AR", icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" },
  ...
  { label: "Mentorship",         href: "#", desc: "Book 1-on-1 sessions", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
];
