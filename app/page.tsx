...
const FEATURES = [
  ...
  { title:"Jewellery Showroom",  href:"/gallery?mode=3d&genre=jewellery", color:"rose", tag:"Premium",
    desc:"High-poly, luxury jewellery models ready for AR Try-On and detailed product renders.",
