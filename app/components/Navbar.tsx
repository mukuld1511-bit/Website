...
const ASSET_LINKS = [
  { label: "3D Models",       href: "/gallery",          desc: "Browse high-end Visualization assets",  icon: "M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" },
  { label: "Upload Asset",    href: "/upload",           desc: "Sell your 3D or CAD designs",           icon: "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" },
  { label: "Scene Composer",  href: "/scene-composer",   desc: "Stage multiple models in a 3D scene",   icon: "M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z" },
];
...
const LEARN_CONNECT_LINKS = [
  ...
  { label: "Forge — Live Collab", href: "/forge",        desc: "Stage models with others in real-time", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
                  ...
                  {profileOpen && (
                    ...
                    >
                      {[
                        ...
                        { label: "Scene Composer",    href: "/scene-composer",  icon: "M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z", color: "text-teal-500",  bg: "bg-teal-50"  },
                        { label: "⚡ Forge",           href: "/forge",           icon: "M13 10V3L4 14h7v7l9-11h-7z",                                                                                                                              color: "text-orange-500", bg: "bg-orange-50" },
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8">
              ...
              <Link href="/collaborators" onClick={() => setMobileMenuOpen(false)}>
                <div className="flex items-center gap-4 group py-2">
                  <div className="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-[#5B4BDB]/10 group-hover:text-[#5B4BDB]">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5" /></svg>
                  </div>
                  <div>
              ...
              {user ? (
                <div className="space-y-3">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-full overflow-hidden bg-gray-200">
                        {user.photoURL ? <img src={user.photoURL} className="w-full h-full object-cover" /> : <div className="w-full h-full bg-gray-300" />}
                      </div>
                      <div>
                  ...
                  <Link href="/dashboard" onClick={() => setMobileMenuOpen(false)}>
                    <button className="w-full py-3.5 rounded-xl font-bold bg-white border border-gray-200 text-gray-900 shadow-sm mb-3">Dashboard</button>
                  </Link>
                ...
                <div className="flex flex-col gap-3">
                  <Link href="/join" onClick={() => setMobileMenuOpen(false)}>
                    <button className="w-full py-4 rounded-xl font-bold bg-[#5B4BDB] text-white shadow-sm">Get Started</button>
                  </Link>
                  <Link href="/login" onClick={() => setMobileMenuOpen(false)}>
                    <button className="w-full py-4 rounded-xl font-bold bg-white border border-gray-200 text-gray-900 shadow-sm">Sign In</button>
                  </Link>
                </div>
              )}
            </div>
